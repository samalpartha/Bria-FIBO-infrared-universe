    ...
    <main className="h-screen w-screen flex flex-col bg-[#1a1a1a] text-[#f5f5f5] overflow-hidden font-sans">
      ...
      <div className="flex-1 flex min-h-0 relative">
        ...
        <div className="flex-1 flex flex-col bg-[#111] overflow-hidden relative">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar relative cinema-canvas">
            ...
            <div className="p-8 max-w-6xl mx-auto space-y-8 relative z-10 transition-all duration-500">
