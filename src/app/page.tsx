              ...
              <div className="flex items-center gap-2 relative">
                {showSearch && (
                  <input
                    ...
                    id="search-input"
                    className="w-40 border border-white/20 rounded px-2 py-1 text-xs placeholder:text-gray-500 focus:outline-none focus:border-[var(--cinema-teal)] animate-in slide-in-from-right-2"
                    style={{ backgroundColor: '#222', color: '#ffffff' }}
                    value={searchQuery}
